...
void rtlSetup() {
  ...
  if (!cfg->demod) {
    ...
    if (rtl_433_ESP::ookModulation) {
      ...
      memcpy(&cfg->devices[64], &generic_soil_moisture, sizeof(r_device));
      memcpy(&cfg->devices[65], &govee, sizeof(r_device));
      memcpy(&cfg->devices[66], &govee_h5054, sizeof(r_device));
      memcpy(&cfg->devices[67], &gt_tmbbq05, sizeof(r_device));
      memcpy(&cfg->devices[68], &gt_wt_02, sizeof(r_device));
      memcpy(&cfg->devices[69], &gt_wt_03, sizeof(r_device));
      memcpy(&cfg->devices[70], &hcs200, sizeof(r_device));
      memcpy(&cfg->devices[71], &hideki_ts04, sizeof(r_device));
      memcpy(&cfg->devices[72], &homelead_hg9901, sizeof(r_device));
      ...
      memcpy(&cfg->devices[101], &nexus_sauna, sizeof(r_device));
      memcpy(&cfg->devices[102], &nice_flor_s, sizeof(r_device));
      memcpy(&cfg->devices[103], &norgo, sizeof(r_device));
      memcpy(&cfg->devices[104], &oil_standard_ask, sizeof(r_device));
      memcpy(&cfg->devices[105], &opus_xt300, sizeof(r_device));
      memcpy(&cfg->devices[106], &oregon_scientific, sizeof(r_device));
      memcpy(&cfg->devices[107], &oregon_scientific_sl109h, sizeof(r_device));
      memcpy(&cfg->devices[108], &oregon_scientific_v1, sizeof(r_device));
      memcpy(&cfg->devices[109], &philips_aj3650, sizeof(r_device));
      memcpy(&cfg->devices[110], &philips_aj7010, sizeof(r_device));
      memcpy(&cfg->devices[111], &proflame2, sizeof(r_device));
      memcpy(&cfg->devices[112], &prologue, sizeof(r_device));
      memcpy(&cfg->devices[113], &proove, sizeof(r_device));
      memcpy(&cfg->devices[114], &quhwa, sizeof(r_device));
      memcpy(&cfg->devices[115], &radiohead_ask, sizeof(r_device));
      memcpy(&cfg->devices[116], &sensible_living, sizeof(r_device));
      memcpy(&cfg->devices[117], &rainpoint, sizeof(r_device));
      memcpy(&cfg->devices[118], &rainpoint_hcs012arf, sizeof(r_device));
      memcpy(&cfg->devices[119], &regency_fan, sizeof(r_device));
      memcpy(&cfg->devices[120], &revolt_nc5462, sizeof(r_device));
      memcpy(&cfg->devices[121], &revolt_zx7717, sizeof(r_device));
      memcpy(&cfg->devices[122], &rftech, sizeof(r_device));
      memcpy(&cfg->devices[123], &risco_agility, sizeof(r_device));
      memcpy(&cfg->devices[124], &rosstech_dcu706, sizeof(r_device));
      memcpy(&cfg->devices[125], &rubicson, sizeof(r_device));
      memcpy(&cfg->devices[126], &rubicson_48659, sizeof(r_device));
      memcpy(&cfg->devices[127], &rubicson_pool_48942, sizeof(r_device));
      memcpy(&cfg->devices[128], &s3318p, sizeof(r_device));
      memcpy(&cfg->devices[129], &schou_72543_rain, sizeof(r_device));
      memcpy(&cfg->devices[130], &schraeder, sizeof(r_device));
      memcpy(&cfg->devices[131], &schrader_EG53MA4, sizeof(r_device));
      memcpy(&cfg->devices[132], &schrader_SMD3MA4, sizeof(r_device));
      memcpy(&cfg->devices[133], &scmplus, sizeof(r_device));
      memcpy(&cfg->devices[134], &secplus_v1, sizeof(r_device));
      memcpy(&cfg->devices[135], &silvercrest, sizeof(r_device));
      memcpy(&cfg->devices[136], &ss_sensor, sizeof(r_device));
      memcpy(&cfg->devices[137], &skylink_motion, sizeof(r_device));
      memcpy(&cfg->devices[138], &smoke_gs558, sizeof(r_device));
      memcpy(&cfg->devices[139], &solight_te44, sizeof(r_device));
      memcpy(&cfg->devices[140], &somfy_rts, sizeof(r_device));
      memcpy(&cfg->devices[141], &springfield, sizeof(r_device));
      memcpy(&cfg->devices[142], &telldus_ft0385r, sizeof(r_device));
      memcpy(&cfg->devices[143], &tfa_30_3221, sizeof(r_device));
      memcpy(&cfg->devices[144], &tfa_drop_303233, sizeof(r_device));
      memcpy(&cfg->devices[145], &tfa_pool_thermometer, sizeof(r_device));
      memcpy(&cfg->devices[146], &tfa_twin_plus_303049, sizeof(r_device));
      memcpy(&cfg->devices[147], &thermopro_tp11, sizeof(r_device));
      memcpy(&cfg->devices[148], &thermopro_tp12, sizeof(r_device));
      memcpy(&cfg->devices[149], &thermopro_tx2, sizeof(r_device));
      memcpy(&cfg->devices[150], &thermopro_tx2c, sizeof(r_device));
      memcpy(&cfg->devices[151], &thermor, sizeof(r_device));
      memcpy(&cfg->devices[152], &tpms_eezrv, sizeof(r_device));
      memcpy(&cfg->devices[153], &tpms_gm, sizeof(r_device));
      memcpy(&cfg->devices[154], &tpms_tyreguard400, sizeof(r_device));
      memcpy(&cfg->devices[155], &ts_ft002, sizeof(r_device));
      memcpy(&cfg->devices[156], &ttx201, sizeof(r_device));
      memcpy(&cfg->devices[157], &vaillant_vrt340f, sizeof(r_device));
      memcpy(&cfg->devices[158], &vauno_en8822c, sizeof(r_device));
      memcpy(&cfg->devices[159], &visonic_powercode, sizeof(r_device));
      memcpy(&cfg->devices[160], &watts_thermostat, sizeof(r_device));
      memcpy(&cfg->devices[161], &waveman, sizeof(r_device));
      memcpy(&cfg->devices[162], &wec2103, sizeof(r_device));
      memcpy(&cfg->devices[163], &wg_pb12v1, sizeof(r_device));
      memcpy(&cfg->devices[164], &ws2032, sizeof(r_device));
      memcpy(&cfg->devices[165], &wssensor, sizeof(r_device));
      memcpy(&cfg->devices[166], &wt1024, sizeof(r_device));
      memcpy(&cfg->devices[167], &wt450, sizeof(r_device));
      memcpy(&cfg->devices[168], &X10_RF, sizeof(r_device));
      memcpy(&cfg->devices[169], &x10_sec, sizeof(r_device));
      memcpy(&cfg->devices[170], &yale_hsa, sizeof(r_device));
    } else {
